...
export function Popup(props) {
 ...
 const CallAPI = async (url) => {
  ...
  const handleDelete = ()=>{
let url="http://localhost:8000/api/RemovePartitionContractByID?PartitionContractID="+props.PartitionContractID
  CallAPI(url);
 
    setShow(false);
    setTimeout(function () {
      window.location.replace('ManagePartitionContracts')
  }, 1000);
...
componentDidMount(){
  ...
  let url ="http://localhost:8000/api/GetAllPartitionContracts"
...
<Container>
      <Row>
        ...
        <p class="text-justify" style={{color:"Black"}}>Partition Contracts Management Table</p>
      ...
      <thead>
        <tr>
          ...
          <th>
Prochaine date de facturation</th>
...
<tr>
          ...
          <Row>
      <Col>
      <IconButton  href={"EditContract?ContractID="+Contract.PContract_ID} aria-label="delete" size="large">
  <AddIcon fontSize="inherit" />
      ...
      <Popup  show={this.state.modalShow}
        ...
        PartitionContractID={Contract.PContract_ID}/>
      </Col>
