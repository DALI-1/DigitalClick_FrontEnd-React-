...
<h1 class="w3-jumbo w3-animate-top w3-center" style={{color:"White"}}><code>Accès refusé</code></h1>
<hr class="w3-border-white w3-animate-left" style={{margin:"auto",width:"50%",Color:"White"}}/>
<h3 style={{color:"White"}} class="w3-center w3-animate-right">
Vous n'êtes pas autorisé à consulter ce site.</h3>
<h3 class="w3-center w3-animate-zoom">🚫🚫🚫🚫</h3>
<h4 style={{color:"White"}} class="w3-center w3-animate-zoom">
Veuillez contacter votre administrateur Mr Rostom Mhiri pour obtenir votre rôle approprié.
</h4>
</div>
</body>
</>
